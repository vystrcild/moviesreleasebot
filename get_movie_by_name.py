...
def get_movie_from_tmdb_by_name(title, year):
    url_api = f"https://api.themoviedb.org/3/search/movie?api_key={TMDB_API_KEY}&language=en-US&query={title}" \
              f"&page=1&include_adult=false&year={year}"
